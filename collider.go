...
#cgo linux  LDFLAGS:  cpp/bridge.o cpp/janus.o cpp/ggml.o cpp/ggml-backend.o cpp/ggml-alloc.o cpp/k_quants.o cpp/ggml-cuda.o  -lstdc++ -lm -lcublas -lculibos -lcudart -lcublasLt -lpthread -ldl -lrt -L/usr/local/cuda/lib64 -L/opt/cuda/lib64 -L/usr/local/cuda/targets/x86_64-linux/lib
#cgo darwin LDFLAGS:  cpp/bridge.o cpp/janus.o cpp/ggml.o cpp/ggml-backend.o cpp/ggml-alloc.o cpp/k_quants.o cpp/ggml-metal.o -lstdc++ -framework Accelerate -framework Foundation -framework Metal -framework MetalKit
*/
import "C"
