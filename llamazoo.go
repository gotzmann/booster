...
#cgo linux CPPFLAGS = -I. -Icommon -DNDEBUG -DLOG_DISABLE_LOGS -DGGML_USE_K_QUANTS -DGGML_USE_CUBLAS -I/usr/local/cuda/include -I/opt/cuda/include -I/usr/local/cuda-12.2/targets/x86_64-linux/include
#cgo linux CFLAGS   = -O3 -std=c17   -fPIC -D_XOPEN_SOURCE=600 -D_GNU_SOURCE -pthread -march=native -mtune=native
#cgo linux CXXFLAGS = -O3 -std=c++17 -fPIC -D_XOPEN_SOURCE=600 -D_GNU_SOURCE -pthread -march=native -mtune=native
#cgo linux LDFLAGS  = bridge.o common.o ggml.o ggml-alloc.o llama.o k_quants.o ggml-cuda.o -lstdc++ -lm -lcublas -lculibos -lcudart -lcublasLt -lpthread -ldl -lrt -L/usr/local/cuda/lib64 -L/opt/cuda/lib64 -L/usr/local/cuda-12.2/targets/x86_64-linux/lib
